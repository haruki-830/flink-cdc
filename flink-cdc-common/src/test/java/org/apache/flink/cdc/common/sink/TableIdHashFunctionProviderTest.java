...
class TableIdHashFunctionProviderTest {
    ...
    void testSingletonInstance() {
        HashFunction<DataChangeEvent> hashFunction1 = provider.getHashFunction(TABLE_A, SCHEMA);
        HashFunction<DataChangeEvent> hashFunction2 = provider.getHashFunction(TABLE_B, SCHEMA);
    ...
    private DataChangeEvent createUpdateEvent(
        ...
        return DataChangeEvent.updateEvent(
                tableId,
                org.apache.flink.cdc.common.data.GenericRecordData.of(
                        id, new BinaryStringData(oldName)),
                org.apache.flink.cdc.common.data.GenericRecordData.of(
                        id, new BinaryStringData(newName)));
    }
