...
class StringFunctionsTest {
    ...
    @Test
    void testLikeUsesSqlWildcards() {
        assertThat(StringFunctions.like("Alice", "A%")).isTrue();
        assertThat(StringFunctions.like("A1", "A_")).isTrue();
        assertThat(StringFunctions.like("A12", "A_")).isFalse();
    ...
    @Test
    void testLikeNullReturnsUnknown() {
