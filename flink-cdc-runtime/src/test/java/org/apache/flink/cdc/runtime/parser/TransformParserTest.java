...
class TransformParserTest {
    ...
    void testTranslateFilterToJaninoExpression() {
        ...
        testFilterExpression("id <> '1'", "not(valueEquals(id, \"1\"))");
        ...
        testFilterExpression("id like 'A%'", "like(id, \"A%\")");
        testFilterExpression("id not like 'A%'", "notLike(id, \"A%\")");
    ...
    void testTranslateUdfFilterToJaninoExpression() {
        ...
        testFilterExpressionWithUdf(
                "typeof(id like 'A%')", "__instanceOfTypeOfFunctionClass.eval(like(id, \"A%\"))");
        testFilterExpressionWithUdf(
                "typeof(id not like 'A%')",
                "__instanceOfTypeOfFunctionClass.eval(notLike(id, \"A%\"))");
        testFilterExpressionWithUdf(
        ...
        testFilterExpressionWithUdf(
                ...
                "or(greaterThan(__instanceOfAddOneFunctionClass.eval(__instanceOfAddOneFunctionClass.eval(id)), 4), and(not(valueEquals(__instanceOfTypeOfFunctionClass.eval(id), \"bool\")), not(valueEquals(__instanceOfFormatFunctionClass.eval(\"from %s to %s is %s\", \"a\", \"z\", \"lie\"), \"\"))))");
        testFilterExpressionWithUdf(
                "ADDONE(ADDONE(id)) > 4 OR TYPEOF(id) <> 'bool' AND FORMAT('from %s to %s is %s', 'a', 'z', 'lie') <> ''",
                "or(greaterThan(__instanceOfAddOneFunctionClass.eval(__instanceOfAddOneFunctionClass.eval(id)), 4), and(not(valueEquals(__instanceOfTypeOfFunctionClass.eval(id), \"bool\")), not(valueEquals(__instanceOfFormatFunctionClass.eval(\"from %s to %s is %s\", \"a\", \"z\", \"lie\"), \"\"))))");
    }
    ...
    public void testTranslateUdfFilterToJaninoExpressionWithColumnNameMap() {
        ...
        testFilterExpressionWithUdf(
                "typeof(`a-b` like 'A%')",
                "__instanceOfTypeOfFunctionClass.eval(like($2, \"A%\"))", columns, columnNameMap);
        testFilterExpressionWithUdf(
                "typeof(`a-b` not like 'A%')",
                "__instanceOfTypeOfFunctionClass.eval(notLike($2, \"A%\"))",
                columns,
                columnNameMap);
        testFilterExpressionWithUdf(
                "typeof(a-b-`a-b`)",
        ...
        testFilterExpressionWithUdf(
                ...
                "or(greaterThan(__instanceOfAddOneFunctionClass.eval(__instanceOfAddOneFunctionClass.eval($2)), 4), and(not(valueEquals(__instanceOfTypeOfFunctionClass.eval($0 - $1), \"bool\")), not(valueEquals(__instanceOfFormatFunctionClass.eval(\"from %s to %s is %s\", \"a\", \"z\", \"lie\"), \"\"))))",
                columns,
                columnNameMap);
        testFilterExpressionWithUdf(
                "ADDONE(ADDONE(`a-b`)) > 4 OR TYPEOF(a-b) <> 'bool' AND FORMAT('from %s to %s is %s', 'a', 'z', 'lie') <> ''",
        ...
        for (String unicodeString : UNICODE_STRINGS) {
            Assertions.assertThat(
                    ...
                    .containsExactly(
                            ...
                            "not(valueEquals($0, \"" + unicodeString + "\"))",
                            "valueEquals($0, castToInteger(\"" + unicodeString + "\"))",
                            "not(valueEquals($0, castToInteger(\"" + unicodeString + "\")))");

            testFilterExpression(
                    "a = '" + unicodeString + "'", "valueEquals(a, \"" + unicodeString + "\")");
            testFilterExpression(
                    "a <> '" + unicodeString + "'",
                    "not(valueEquals(a, \"" + unicodeString + "\"))");
        }
    }
